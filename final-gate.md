...
| Unit and integration tests | `cargo test --offline --all-targets` passed: 68 library tests, the UDP/TCP resolver fixture, and 8 fake-upstream tests against GitHub Proxima revision `0652a0c0`. |
